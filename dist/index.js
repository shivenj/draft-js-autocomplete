...
var store = shared.store || (shared.store = new (__webpack_require__(100))());
...
if (__webpack_require__(8)) {
  ...
  var toInteger = __webpack_require__(24);
  var toLength = __webpack_require__(6);
  var toIndex = __webpack_require__(98);
...
exports.getSuggestions = undefined;
...
var getSuggestions = exports.getSuggestions = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(autocomplete, match) {
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            if (!(typeof autocomplete.onMatch !== 'function')) {
              _context.next = 2;
              break;
            }
          ...
          case 2:
            _context.prev = 2;
            _context.next = 5;
            return autocomplete.onMatch(match.text);
...
exports.isCurrentTextEmpty = isCurrentTextEmpty;
exports.isCurrentSelectionAnEntity = isCurrentSelectionAnEntity;
exports.getMatch = getMatch;
exports.getAutocomplete = getAutocomplete;
exports.addEntityToEditorState = addEntityToEditorState;
...
function findWithRegex(regex, contentBlock, callback) {
  ...
  while ((matchArr = regex.exec(text)) !== null) {
    ...
    var length = matchArr[0].trim().length;
...
function getSelectionPosition() {
  ...
  var parent = selection.getRangeAt(0).startContainer.parentElement;
 ...
 * @returns {boolean}
 */
function isCurrentTextEmpty(editorState) {
  var selectionState = editorState.getSelection();
  var anchorKey = selectionState.getAnchorKey();
  var currentContent = editorState.getCurrentContent();
  var currentContentBlock = currentContent.getBlockForKey(anchorKey);
  var currentText = currentContentBlock.getText();
 ...
 * @returns {boolean}
 */
function isCurrentSelectionAnEntity(editorState) {
  var selectionState = editorState.getSelection();
  var anchorKey = selectionState.getAnchorKey();
  var currentContent = editorState.getCurrentContent();
  var currentContentBlock = currentContent.getBlockForKey(anchorKey);
  ...
  var entityBefore = currentContentBlock.getEntityAt(startOffset - 1);
  var entityAfter = currentContentBlock.getEntityAt(endOffset);
 ...
 * @returns {*}
 */
function getMatch(editorState, matches) {
  var selectionState = editorState.getSelection();
  var anchorKey = selectionState.getAnchorKey();

  // No matches for this block no need to continue
  if (!matches[anchorKey]) return null;
  var currentBlockMatches = matches[anchorKey];

  var startOffset = selectionState.getStartOffset();

  // For all matches in this block, we reduce all types
  // to get the first match, return null if no match found
  return Object.keys(currentBlockMatches).reduce(function (previous, type) {
    // Only if no match found yet
    if (previous === null) {
      // Reduce all matches to get the first one that is in selection
      // return null if no match found
      return currentBlockMatches[type].reduce(function (previous, match) {
        var inOffset = startOffset >= match.start && startOffset <= match.end;
        return !inOffset ? previous : _extends({}, match, {
          type: type
        });
      }, null);
    }
 ...
 * @returns {*}
 */
function getAutocomplete(autocompletes, match) {
  return autocompletes.reduce(function (previous, autocomplete) {
    return previous === null && autocomplete.type === match.type ? autocomplete : previous;
  }, null);
}function addEntityToEditorState(editorState, item, match) {
  ...
  var contentStateWithEntity = contentState.createEntity(type, mutability, item);
  var entityKey = contentStateWithEntity.getLastCreatedEntityKey();

  // Replace selection with the new create entity
  var newContentState = _draftJs.Modifier.replaceText(contentStateWithEntity, selection, format(item), null, entityKey);

  // Push new contentState with type
  var newEditorState = _draftJs.EditorState.push(editorState, newContentState, 'insert-autocomplete');
...
var Autocomplete = function (_Component) {
  ...
  function Autocomplete(props) {
    ...
    _this.createEntityStrategy = _this.createEntityStrategy.bind(_this);
    _this.createAutocompleteStrategy = _this.createAutocompleteStrategy.bind(_this);
    _this.updateMatch = _this.updateMatch.bind(_this);
    _this.resetMatch = _this.resetMatch.bind(_this);
    _this.getChildren = _this.getChildren.bind(_this);
    _this.buildSuggestionsList = _this.buildSuggestionsList.bind(_this);
    _this.onSuggestionClick = _this.onSuggestionClick.bind(_this);
    _this.addEntityWithSelectedSuggestion = _this.addEntityWithSelectedSuggestion.bind(_this);
  ...
  _createClass(Autocomplete, [{
    ...
    value: function componentDidMount() {
      ...
      var newEditorState = _draftJs.EditorState.set(editorState, { decorator: decorator });
      // Call onChange to
    ...
    value: function getDecorator() {
      ...
      var _props2 = this.props,
          autocompletes = _props2.autocompletes,
          additionalDecorators = _props2.additionalDecorators;


      var strategies = autocompletes.reduce(function (previous, autocomplete) {
        var entityStrategy = {
          strategy: _this2.createEntityStrategy(autocomplete.type),
          component: autocomplete.component
        };
        var autocompleteStrategy = {
          strategy: _this2.createAutocompleteStrategy(autocomplete),
      ...
      return new _draftJs.CompositeDecorator(strategies);
    }
    ...
    key: 'createEntityStrategy',
    value: function createEntityStrategy(type) {
    ...
    key: 'createAutocompleteStrategy',
    value: function createAutocompleteStrategy(autocomplete) {
      var _this3 = this;
    ...
    value: function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var _state, matches, focus, _props3, editorState, autocompletes, match, autocomplete, suggestions, position, newMatch, selectedSuggestion, lastSuggestionIndex;

        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _state = this.state, matches = _state.matches, focus = _state.focus;
                _props3 = this.props, editorState = _props3.editorState, autocompletes = _props3.autocompletes;

                // Reset if text is empty

                if (!(0, _utils.isCurrentTextEmpty)(editorState)) {
                  _context.next = 4;
                  break;
                }

                return _context.abrupt('return', this.resetMatch());

              case 4:
                if (!(0, _utils.isCurrentSelectionAnEntity)(editorState)) {
                  _context.next = 6;
                  break;
                }
              ...
              case 6:
                ...
                match = (0, _utils.getMatch)(editorState, matches);
              ...
              case 9:
                ...
                autocomplete = (0, _utils.getAutocomplete)(autocompletes, match);
              ...
              case 12:
                _context.next = 14;
                return (0, _utils.getSuggestions)(autocomplete, match);
              ...
              case 14:
                ...
                if (focus) {
                  position = (0, _utils.getSelectionPosition)();
                }

                // New match is a merge of previous data
                newMatch = _extends({}, match, autocomplete, {
                ...
                lastSuggestionIndex = suggestions.length > 0 ? suggestions.length - 1 : 0;
    ...
    value: function getChildren() {
      ...
      var _props4 = this.props,
          ...
          rest = _objectWithoutProperties(_props4, ['editorState', 'children', 'onChange']);

      var childrenProps = _extends({}, rest, {
    ...
    key: 'buildSuggestionsList',
    value: function buildSuggestionsList() {
      var _this4 = this;
      ...
      var suggestions = match.suggestions,
          position = match.position;


      if (!suggestions || suggestions.length === 0) return null;

      var List = match.listComponent;
      var Item = match.itemComponent;

      var items = suggestions.map(function (item, index) {
        // Create onClick callback for each item so we can pass params
        var onClick = function onClick() {
          _this4.onSuggestionClick(item, match);
        };
      ...
      return _react2.default.createElement(
        List,
        _extends({ display: focus }, position),
        items
      );
    }
    ...
    value: function onSuggestionClick(item, match) {
    ...
    key: 'addEntityWithSelectedSuggestion',
    value: function addEntityWithSelectedSuggestion() {
      ...
      if (match.suggestions[selectedSuggestion]) {
        var item = match.suggestions[selectedSuggestion];
        var newEditorState = (0, _utils.addEntityToEditorState)(editorState, item, match);
        this.resetMatch();
        onChange(newEditorState);
        return true;
    ...
    value: function onDownArrow(e) {
      var _state4 = this.state,
          focus = _state4.focus,
          match = _state4.match,
          selectedSuggestion = _state4.selectedSuggestion;

      // Prevent default if match displayed

      if (focus && match) {
        var lastSuggestionIndex = match.suggestions.length > 0 ? match.suggestions.length - 1 : 0;
        e.preventDefault();
    ...
    value: function onUpArrow(e) {
      var _state5 = this.state,
          focus = _state5.focus,
          match = _state5.match,
          selectedSuggestion = _state5.selectedSuggestion;
    ...
    value: function keyBindingFn(e) {
      var keyBindingFn = this.props.keyBindingFn;
      ...
      return keyBindingFn ? keyBindingFn(e) : (0, _draftJs.getDefaultKeyBinding)(e);
    }
  }, {
    key: 'handleKeyCommand',
    value: function handleKeyCommand(command) {
      var handleKeyCommand = this.props.handleKeyCommand;
    ...
    value: function render() {
      var childrenWithProps = this.getChildren();
      var suggestions = this.buildSuggestionsList();
...
$export($export.S, 'Math', { scale: __webpack_require__(91) });
...
var $export = __webpack_require__(0);
var flattenIntoArray = __webpack_require__(96);
var toObject = __webpack_require__(9);
var toLength = __webpack_require__(6);
var toInteger = __webpack_require__(24);
...
$export($export.G + $export.W + $export.F * !__webpack_require__(52).ABV, {
  DataView: __webpack_require__(64).DataView
});
